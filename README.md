...
### Instruction to Run this project on any system.

Make sure you have installed ruby in your system.

Then on terminal change directory to project directory.

**Run following commands**

`bundle install` *to install required gems.*

*After successfully installed run rspec to test the exercise.*

`rspec`

#### Explanation of implementation
The *lib/code.rb* is having whole logic of this toy robot excercise.

And there are test cases to check different scenarios of this excercise inside *rspec/robot_spec.rb*

There are test files that have instructions for toy robots are inside *rspec/factory_data* directory.
